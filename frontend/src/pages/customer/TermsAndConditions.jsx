  ...
  return (
    <div className="min-h-screen px-4 py-8 md:px-8 bg-muted/40">
      <div className="mx-auto">
        <PolicyCard title="Terms &amp; Conditions" version="Version 1.0">
          <div className="prose max-w-none">
            <ol className="list-decimal pl-6 space-y-2">
              ...
              <li>
                ...
                regulations, privacy policy and Terms of Use for access or usage of domain name https://yosai.in
                ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
              </li>
              <li>
                The Platform is owned by S Square International, a company incorporated under the Companies
                Act, 1956 with its registered office at No 2, Rajagopalan Street, West Mambalam, Chennai,
            ...
            <div className="mb-2">The use of Platform and/or availing of our Services is subject to the following Terms of Use:</div>
            <ol className="list-decimal pl-6 space-y-2">
              ...
              <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Chennai and Tamil Nadu.</li>
