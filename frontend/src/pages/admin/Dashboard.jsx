  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 text-sm mt-1">Platform overview and insights</p>
      </div>
      ...
      <div className="card p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <a href="/admin/orders" className="text-sm text-purple-600 hover:underline">View all</a>
        </div>
              ...
              <tbody className="divide-y divide-gray-50">
                {recentOrders.map(order => (
                  <tr key={order._id} className="hover:bg-gray-50 transition-colors">
                    <td className="py-2.5 font-mono text-xs text-purple-600">{order.orderNumber || order._id?.slice(-8)}</td>
